...
entries_to_select = ['solar', 'solar rooftop', 'onwind','solar-hsat',
                      ...
                      'rural oil boiler_2','solar Electrolyser_2','onwind Electrolyser_2','offwind-ac Electrolyser_2','offwind-dc Electrolyser_2',
...
entry_label_mapping = {
    ...
    'solar Electrolyser':{'label': 'solar connected electrolyser', 'source': 'TWh', 'target': 'proesolh'},
    'onwind Electrolyser':{'label': 'onwind connected electrolyser', 'source': 'TWh', 'target': 'proeonh'},
    'offwind-ac Electrolyser':{'label': 'offwind-ac connected electrolyser', 'source': 'TWh', 'target': 'proeoffach'},
    'offwind-dc Electrolyser':{'label': 'offwind-dc connected electrolyser', 'source': 'TWh', 'target': 'proeoffdch'},
    'solar Electrolyser_2':{'label': 'solar connected electrolyser losses', 'source': 'TWh', 'target': 'proesolhlos'},
    'onwind Electrolyser_2':{'label': 'onwind connected electrolyser losses', 'source': 'TWh', 'target': 'proeonhlos'},
    'offwind-ac Electrolyser_2':{'label': 'offwind-ac connected electrolyser losses', 'source': 'TWh', 'target': 'proeoffachlos'},
    'offwind-dc Electrolyser_2':{'label': 'offwind-dc connected electrolyser losses', 'source': 'TWh', 'target': 'proeoffdchlos'},
